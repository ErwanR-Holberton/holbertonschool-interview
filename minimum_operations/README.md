...
<li>All your files must be executable</li>
    ...
    <div data-role="task21162" data-position="1" id="task-num-0">
      <div class="panel panel-default task-card " id="task-21162">
...
<pre><code>carrie@ubuntu:~/minoperations$ cat 0-main.py
#!/usr/bin/python3
"""
...
<pre><code>carrie@ubuntu:~/minoperations$ ./0-main.py
      ...
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>holbertonschool-interview</code></li>
            <li>Directory: <code>minimum_operations</code></li>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="21162" data-batch-id="395" data-toggle="modal" data-target="#task-21162-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-21162-users-done-modal" data-task-id="21162" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "0. Minimum Operations"</h4>
        </div>
      ...
      <button class="btn btn-default btn-sm" data-task-id="21162" data-toggle="modal" data-target="#task-test-correction-21162-correction-modal" id="task-num-0-check-code-btn">
          Review your work
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-21162-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "0. Minimum Operations"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="21162">Start a new test</button>
                ...
                <div class="help">
    <button data-task-id="21162">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="21162">
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#sandboxes-modal"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-21162-score-info-score">0</span>/12
            </strong>
