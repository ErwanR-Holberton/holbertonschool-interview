...
<li>
  ...
  <div data-container="body" data-placement="right" data-toggle="tooltip" title="" data-original-title="My Profile">
    <a href="/users/my_profile">
        <div class="image ">
          <div class="inner" style="background-image: url('https://s3.eu-west-3.amazonaws.com/hbtn.intranet/users/photos/000/006/218/thumb/PPHolberton.JPG?X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA4MYA5JM5DUTZGMZG%2F20240515%2Feu-west-3%2Fs3%2Faws4_request&amp;X-Amz-Date=20240515T153712Z&amp;X-Amz-Expires=600&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=d4314256449525cb0cd16458bb8495636e1cf577f2bf3290ec2f915045e4f925')"></div>
        </div>
          ...
          <a class="" href="/curriculums/341/observe/33621">
            <div class="align-items-center d-flex py-2">
              <div class="d-flex flex-column" style="line-height: 16px">
                ...
                <span class="text-muted">
                  Average: <span class="fw-500">97.81%
                  </span>
                </span>
              </div>
            </div>
...
<li>All your header files should be include guarded</li>
    ...
    <div data-role="task20928" data-position="13" id="task-num-0">
      <div class="panel panel-default task-card " id="task-20928">
      ...
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>holbertonschool-interview</code></li>
            <li>Directory: <code>insert_in_sorted_linked_list</code></li>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="20928" data-batch-id="395" data-toggle="modal" data-target="#task-20928-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-20928-users-done-modal" data-task-id="20928" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "0. Insert in sorted linked list"</h4>
        </div>
      ...
      <button class="btn btn-default btn-sm" data-task-id="20928" data-toggle="modal" data-target="#task-test-correction-20928-correction-modal" id="task-num-0-check-code-btn">
          Review your work
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-20928-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "0. Insert in sorted linked list"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20928">Start a new test</button>
                ...
                <div class="help">
    <button data-task-id="20928">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20928">
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#sandboxes-modal"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-20928-score-info-score">0</span>/8
            </strong>
